...
void version(){
    cout<<"Versión "<<1<<"."<<5<<"."<<2<<" - Solo para desarrolladores - ¡No distribuir!"<<endl;
...
int cod_verificador=0;// Verifica que el codigo que se ingrese este dentro de los validos
int menu_modo;// Verifica si es 0 es valido en el menu (para terminar orden) o no
            ...
            case '1':{
                ...
                do{
                    ...
                    if(opc_orden != 0){
                        ...
                        orden[num_orden][num_cliente].cantidad_item=cantitem;
                    ...
                    do{
                    	...
                    	switch(opcm){
                    		case 1:{
			                    ...
			                    orden[agregarm][bscr].cantidad_item=cantitem;
